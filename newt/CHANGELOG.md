...
### Changed
- Newt version bumped to 1.11.0 (https://github.com/fosrl/newt/releases/tag/1.11.0)

## [1.10.4-1] - 2026-03-30

### Changed
- Newt version bumped to 1.10.4 (https://github.com/fosrl/newt/releases/tag/1.10.4)
...
### Changed
- Newt version bumped to 1.10.2 (https://github.com/fosrl/newt/releases/tag/1.10.2)

## [1.10.1-1] - 2026-02-27

### Changed
- Newt version bumped to 1.10.1 (https://github.com/fosrl/newt/releases/tag/1.10.1)

## [1.10.0-1] - 2026-02-24

### Changed
- Newt version bumped to 1.10.0 (https://github.com/fosrl/newt/releases/tag/1.10.0)
